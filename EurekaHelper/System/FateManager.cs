...
namespace EurekaHelper.System
{
    public class FateManager : IDisposable
    {
        ...
        private void OnUpdate(IFramework framework)
        {
            ...
            {
                List<IFate> instanceFates = DalamudApi.FateTable.Where(x => !Utils.IsBunnyFate(x.FateId)).ToList();
            ...
            List<IFate> currFates = DalamudApi.FateTable.Except(lastFates).ToList();
